            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action ="simpan_goods.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Name</label>
                          <input type="text" class="form-control" id="name_goods" name="name_goods" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="deskription_goods" name="deskription_goods" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="selled_goods" name="selled_goods" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="price_goods" name="price_goods" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                     ...
                     <td><img src="<?php echo $value['images'] ?>" alt="image goods" style="max-width: 50px"></td>
                      <!--Tombol Update-->
                      <td><a href="update_goods.php?id_goods=<?php echo $value['id_goods'] ?>" type="button" class="close">
                        <span class="fa fa-pencil"></span>
                      </a></td>
                      <!--Tombol Hapus-->
                      <td><a href="hapus_goods.php?id_goods=<?php echo $value['id_goods'] ?>" type="button" class="close">
