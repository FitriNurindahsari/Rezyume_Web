<?php
  include 'koneksi.php';
  session_start();
  $outlet = "SELECT * FROM outlet";
  $data_outlet = $conn->query($outlet);
  $qselect_outlet = "SELECT * FROM outlet WHERE id_outlet = ".$_GET['id_outlet'];
  foreach($conn->query($qselect_outlet) as $value){
    $data_select_outlet=$value;
  } ;
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;" style="color: white;">Outlet</a>
            </div>
            ...
            <div class="collapse navbar-collapse justify-content-end">
              <form class="navbar-form">
                <div class="input-group no-border">
                  <input type="text" value="" class="form-control" placeholder="Search..." style="color: white;">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="user.html" id="navbarDropdownProfile" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <input type="hidden" name="id_outlet" value="<?php echo $data_select_outlet["id_outlet"] ?>">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Name Outlet</label>
                          <input type="text" class="form-control" id="name_outlet" name="name_outlet" value="<?php echo $data_select_outlet["name_outlet"] ?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating"> ID Owner</label>
                          <input type="text" class="form-control" id="id_owner" name="id_owner" value="<?php echo $data_select_outlet["id_owner"] ?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="address_outlet" name="address_outlet" value="<?php echo $data_select_outlet["address_outlet"] ?>" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="deskription_outlet" name="deskription_outlet" value="<?php echo $data_select_outlet["deskription_outlet"] ?>" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <a href="outlet.php" style="background-color: grey; color:white; border:none; border-radius: 5px; padding: 13px 20px;" class="button" type="submit">Batal</a>
                  </form>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  <table class="table">
                    <thead class=" text-primary">
                      <th>ID</th><th>Name Outlet</th><th>ID Owner</th><th>Address</th><th>Deskription</th><th>Edit</th>
                    </thead>
                    <tbody>
                      <?php
                        foreach($data_outlet as $index => $value){
                          echo "<tr>
                            <td>".$value['id_outlet']."</td>
                            <td>".$value['name_outlet']."</td>
                            <td>".$value['id_owner']."</td>
                            <td>".$value['address_outlet']."</td>
                            <td>".$value['deskription_outlet']."</td>"
                      ?>
                      <!--Tombol Update-->
                      <td><a href="update_outlet.php?id_outlet=<?php echo $value['id_outlet'] ?>" type="button" class="close">
                        <span class="fa fa-pencil"></span>
                      </a></td>
                      <!--Tombol Hapus-->
                      <td><a href="hapus_outlet.php?id_outlet=<?php echo $value['id_outlet'] ?>" type="button" class="close">
